...
await searchForTickets.goToMainPage(findTicketsData.link);
  ...
  await searchForTickets.verifyPageResult();
  await searchForTickets.selectFirstTicket();
  await fillData.fillPassengerData(findTicketsData.firstName, findTicketsData.lastName,  findTicketsData.discountList, findTicketsData.phoneNumber, findTicketsData.email);
